...
RUN apk add --no-cache apache2 git php7 php7-ctype php7-tokenizer php7-session php7-apache2 php7-xml php7-json php7-pdo php7-pdo_mysql php7-curl php7-ldap php7-xml php7-soap php7-mbstring curl php7-mysqli 
#clone openemr
